...
if not SECRET_KEY or SECRET_KEY.startswith("django-insecure"):
    raise RuntimeError(
        ...
        "Set DJANGO_SECRET_KEY or SECRET_KEY environment variable."
    )
...
if not DEBUG:
    ...
    SESSION_COOKIE_SECURE = True  # Habilitado para HTTPS (Cloudflare)
...
DATABASES = {
    'default': {
        ...
        'CONN_MAX_AGE': env.int('DB_CONN_MAX_AGE', default=120),
...
# Allow files up to >3MB so custom validation can enforce 3MB limit cleanly.
...
# SMTP Backend para envío de emails
