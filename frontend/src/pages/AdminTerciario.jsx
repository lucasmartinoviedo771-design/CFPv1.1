    ...
    <div className="space-y-6 max-w-xl">
      ...
      <div className="bg-white rounded-2xl border border-[#b8ccd8] shadow-sm p-6">
        <div className="flex items-center justify-between gap-4">
          <div>
            <p className="font-black text-[#1a1f4e] text-base">Preinscripciones</p>
            <p className="text-sm text-[#1a1f4e]/50 mt-0.5">
              {cfg.abierta
                ? "El formulario público está activo y acepta inscripciones."
                : "El formulario está cerrado. Los visitantes ven el mensaje de cierre."}
            </p>
          </div>
          <button
      ...
      <div className="bg-white rounded-2xl border border-[#b8ccd8] shadow-sm p-6 space-y-3">
        <div>
          ...
          <p className="text-xs text-[#1a1f4e]/50 mt-1">Al aprobar una preinscripción, el sistema inscribe al estudiante automáticamente en la cohorte de HD Módulo 2 activa según la fecha, igual que CFP.</p>
        </div>
        {cohorteActiva ? (
          ...
          <div className="p-4 rounded-xl bg-orange-50 border border-orange-200 text-orange-700 text-sm font-semibold flex items-center gap-2">
            <AlertCircle size={16} /> No hay cohorte activa ni próxima en CFP para HD Módulo 2. Los aprobados no se inscribirán automáticamente hasta que CFP cree una.
          </div>
        )}
      </div>

      <div className="bg-white rounded-2xl border border-[#b8ccd8] shadow-sm p-6 space-y-4">
        <h2 className="font-black text-[#1a1f4e]">Período de preinscripción</h2>
        ...
        {(cfg.fecha_inicio || cfg.fecha_fin) && (
          <div className="p-3 rounded-xl bg-[#f5c518]/10 border border-[#f5c518]/30 text-xs text-[#1a1f4e]/70 font-medium">
            Período guardado: {cfg.fecha_inicio || "—"} → {cfg.fecha_fin || "—"}
          </div>
        )}
