...
import { CheckCircle2, User, FileText, Smartphone, GraduationCap } from "lucide-react";
...
export function ProgressBar({ currentStep, totalSteps, isDark }: ProgressBarProps) {
  const steps = [
