...
# Almacenamiento seguro FUERA del directorio del proyecto (en /opt/backups)
...
# Mantener solo los respaldos de los últimos 15 días para no saturar el disco
find "$BACKUP_DIR" -type f -name "cfp_backup_*.sql.gz" -mtime +15 -delete
